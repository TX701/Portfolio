...
export const portfolioHTML = (num) => {
    return `<div class="portfolio" id="portfolio${num}">
                ...
                <div class="works">
                    ...
                    <p>Due to some future websites I had planned, I spent some time focusing on making scrapers. This scraper works with the website "Backloggd", a site thats anologous to "Letterboxd".</p>
...
export const aboutHTML = (num) => {
    return `<div class="about" id="about${num}">
                ...
                <div class="about-wrapper">
                    <h1>Rory Strachan</h1>
                    <p>I have always had a large appreciation for creative endeavors; I largely focused my time on more standard forms of art growing up. In high school I realized that programming was another tool that could vastly increase the kinds of things I could create. Paintings are nice, and I still do love them, but I really like being able to make things people can play with more directly.</p>
                    ...
                    <p>(248) 413-7462</p>
                    <a class="icon" href="https://github.com/TX701" target="_blank"><i class='bx bxl-github'></i></a>
                    </div>
                </div>
